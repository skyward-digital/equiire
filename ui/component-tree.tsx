          ...
          <div className="space-y-6">
            <div className="space-y-3 rounded-lg bg-gray-900 p-4">
              <div className="flex items-center justify-between gap-x-3">
                <div className="bg-blue-600 rounded-md px-2 py-0.5 text-xs tabular-nums tracking-wider text-blue-50">
                  <CountUp
              ...
              <div className="overflow-hidden rounded-full bg-gray-700">
                <div
                  className={clsx(
                    'bg-blue-600 h-2 animate-[translateXReset_1s_ease-in-out_1_reverse] rounded-full',
                  )}
                  style={{
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-x-3 text-sm text-gray-400">
                <div className="bg-blue-600 rounded-md px-2 py-0.5 text-xs tracking-widest text-white/50">
                  {'</>'}
                </div>
