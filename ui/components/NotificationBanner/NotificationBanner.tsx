...
export const NotificationBanner = ({
  ...
  return (
    <div className="flex w-full flex-col items-center justify-between gap-4 rounded-lg border bg-white p-4 shadow-sm dark:border-gray-500 dark:bg-black sm:flex-row sm:gap-0">
      <div className="flex items-center">
        ...
        <p className="font-brand -mb-1 font-semibold sm:text-2xl">{message}</p>
      </div>

      {link ? (
        <Button className="w-full sm:w-auto" href={link} variant="primary">
          {linkLabel}
        </Button>
      ) : null}
    </div>
