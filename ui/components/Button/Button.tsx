...
const classes = {
  ...
  primary:
    'bg-brand-primary shadow-xs hover:bg-brand-secondary rounded-full text-white py-3 disabled:bg-gray-200 dark:disabled:bg-gray-800 dark:disabled:text-gray-500',
