...
export interface ButtonBaseProps {
  variant?: 'primary' | 'secondary' | 'secondary-brand' | 'link' | 'tertiary';
  size?: 'sm' | 'md' | 'lg';
  ...
  return (
    <Component
      ...
      className={clsx(
        ...
        variant === 'tertiary' &&
          'bg-gray-100 text-sm text-gray-400 hover:text-gray-500 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-500',
        // Size
