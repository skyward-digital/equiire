...
export const Header = ({ user }: { user: User }) => {
  return (
    <header className="from-brand to-brand-400 fixed top-0 z-10 flex max-h-20 w-full items-center justify-center border-b border-transparent bg-gradient-to-r px-6 py-2 dark:border-gray-600 dark:from-black dark:to-black lg:justify-between">
