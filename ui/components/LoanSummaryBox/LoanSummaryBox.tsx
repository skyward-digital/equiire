...
export function LoanSummaryBox({ size }: SummaryBoxProps) {
  return (
    <section
    ...
    >
      ...
      {size === 'lg' && (
        <div className="relative">
          ...
          <div className="absolute -bottom-[76px] right-0 flex items-center gap-3 sm:right-10 sm:top-1/2 sm:-translate-y-1/2">
            <PiggyBankIcon className="stroke-gray-600 dark:stroke-white" />
            <Badge type="warning">Credit Builder</Badge>
          </div>
        </div>
      )}
      <div
      ...
      >
        ...
        <div className="flex flex-1 flex-col gap-7">
          ...
          {size == 'sm' && (
            <>
              <SummaryBoxLine Icon={CurrencyDollarIcon} value="Credit Builder">
                Loan Type
              </SummaryBoxLine>
              <Divider />
            </>
